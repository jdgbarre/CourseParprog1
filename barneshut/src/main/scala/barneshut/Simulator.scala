...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics) {
  ...
  def updateBoundaries(boundaries: Boundaries, body: Body): Boundaries = {
    ...
    val update: Boundaries = new Boundaries

    update.maxX = boundaries.maxX max body.x
    update.maxY = boundaries.maxY max body.y
    update.minX = boundaries.minX min body.x
    update.minY = boundaries.minY min body.y
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries = {
    ...
    val merge: Boundaries = new Boundaries

    merge.maxX = a.maxX max b.maxX
    merge.maxY = a.maxY max b.maxY
    merge.minX = a.minX min b.minX
    merge.minY = a.minY min b.minY
